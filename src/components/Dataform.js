...
const Dataform = () => {
  ...
  const updateJsonFile = async () => {
    try {
      const response = await axios.post(
        "http://localhost:5000/update-json",
        data,
        {
          headers: {
  ...
  const handleTechChangeInBuiltProject = (
    projectIndex,
    techIndex,
    newValue
  ) => {
    ...
    <Box sx={{ padding: 2, color: "white" }}>
      ...
      <Box sx={{ marginBottom: 4 }}>
        ...
        {data?.worked?.map((company, projectIndex) => (
          <Box
            key={projectIndex}
            sx={{ marginBottom: 2, border: "1px solid grey", padding: "10px" }}
          >
            <CustomTextField
              fullWidth
              label="Company Name"
              ...
              onChange={(e) =>
                handleWorkedNameChange(projectIndex, e.target.value)
              }
              sx={{ marginBottom: 2 }}
            />
            <CustomTextField
              ...
              value={company?.role}
              onChange={(e) =>
                handleWorkedRoleChange(projectIndex, e.target.value)
              }
              sx={{ marginBottom: 2 }}
            />
            <CustomTextField
              ...
              value={company?.time}
              onChange={(e) =>
                handleWorkedTimeChange(projectIndex, e.target.value)
              }
              sx={{ marginBottom: 2 }}
            />
            ...
            {company.worked.map((tech, techIndex) => (
              ...
              >
                ...
                />
                <IconButton
                  onClick={() => handleWorkedFromWork(projectIndex, techIndex)}
                >
                  <RemoveIcon style={{ color: "red" }} />
                </IconButton>
              </Box>
            ...
            <MyButton
              text="Add New Work"
              clickHandler={() => handleAddWorkedtoWorked(projectIndex)}
            />

            <MyButton
              text="Remove Work Experience"
              clickHandler={() => handleRemoveWorked(projectIndex)}
            />
          </Box>
        ))}
        ...
        {data?.built?.map((project, projectIndex) => (
          ...
          >
            <CustomTextField
              ...
              value={project.name}
              onChange={(e) =>
                handleBuiltProjectNameChange(projectIndex, e.target.value)
              }
              sx={{ marginBottom: 2 }}
            />
            <CustomTextField
              ...
              value={project.desc}
              onChange={(e) =>
                handleBuiltProjectDescriptionChange(
                  projectIndex,
                  e.target.value
                )
              }
            ...
            {project.technologies.map((tech, techIndex) => (
              ...
              >
                <CustomTextField
                  ...
                  value={tech}
                  onChange={(e) =>
                    handleTechChangeInBuiltProject(
                      projectIndex,
                      techIndex,
                      e.target.value
                    )
                ...
                <IconButton
                  onClick={() =>
                    handleRemoveTechFromBuiltProject(projectIndex, techIndex)
                  }
                >
                  <RemoveIcon style={{ color: "red" }} />
                </IconButton>
            ...
            <MyButton
              ...
              clickHandler={() => handleAddTechToBuiltProject(projectIndex)}
            />
            <MyButton
              text="Remove New Built Project"
              clickHandler={() => handleRemoveBuiltProject(projectIndex)}
            />
          </Box>
        ))}
        <MyButton
          big
          text="Add New Built Project"
          clickHandler={handleAddBuiltProject}
        />
      </Box>
        ...
        {data.projects.map((project, projectIndex) => (
          ...
          >
            ...
            <CustomTextField
              ...
              value={project.desc}
              onChange={(e) =>
                handleProjectDescriptionChange(projectIndex, e.target.value)
              }
              sx={{ marginBottom: 2 }}
            />
            ...
            {project.technologies.map((tech, techIndex) => (
              ...
              >
                ...
                <IconButton
                  onClick={() =>
                    handleRemoveTechFromProject(projectIndex, techIndex)
                  }
                >
                  <RemoveIcon style={{ color: "red" }} />
                </IconButton>
